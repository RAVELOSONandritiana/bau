            ...
            <div *ngFor="let collection of collections; let i = index" 
              ...
              <div class="p-8 flex flex-col flex-grow bg-white">
                ...
                <div class="mt-auto flex items-center justify-between">
                  ...
                  <div class="w-10 h-10 rounded-full border border-gray-100 flex items-center justify-center bg-gray-50 group-hover:bg-green-500 group-hover:text-white group-hover:border-green-500 transition-all duration-300">
